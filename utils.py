...
class Trainer(object):
    def __init__(self, 
        ...
        if lr_scheduler is None:
            self.lr_scheduler = optim.lr_scheduler.ReduceLROnPlateau(self.optimizer, factor=0.5, patience=3, threshold=1e-8)
        else:
    ...
    def train_one_epoch(self, loader):
        ...
        for data in loader:
            ...
            with torch.cuda.amp.autocast(enabled=self.fp16):
                preds, truths, loss, f1 = self.train_step(data)
    ...
    def evaluate_one_epoch(self, loader):
        ...
        with torch.no_grad():
            ...
            for data in loader:    
                ...
                with torch.cuda.amp.autocast(enabled=self.fp16):
                    preds, truths, loss, f1 = self.eval_step(data)
        ...
        average_f1 = total_f1 / self.local_step
        average_loss = total_loss / self.local_step
        self.stats["valid_loss"].append(average_loss)
        self.stats_f1.append(average_f1)
        ...
        self.log(f"++> Average F1 score: {average_f1}.")
        self.log(f"++> Average f1 for all passed epochs: {self.stats_f1}")
